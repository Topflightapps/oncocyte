    ...
    echo '<div class="format-setting type-border ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'width', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-sixth"><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'width', 'uncode-core' ) . '" /></div>';
        ...
        if ( in_array( 'unit', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'unit', 'uncode-core' ) . '</option>';
        ...
        if ( in_array( 'style', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[style]" id="' . esc_attr( $field_id ) . '-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'style', 'uncode-core' ) . '</option>';
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<p>' . esc_html__( 'No Categories Found', 'uncode-core' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-category-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<option value="">' . esc_html__( 'No Categories Found', 'uncode-core' ) . '</option>';
        }
...
if ( ! function_exists( 'ot_type_custom_post_type_checkbox' ) ) {
  ...
  function ot_type_custom_post_type_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      /* description */
      if ($has_desc) '<div class="description">' . htmlspecialchars_decode( $field_desc ) . '</div>';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<p>' . esc_html__( 'No Posts Found', 'uncode-core' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . esc_html__( 'No Posts Found', 'uncode-core' ) . '</option>';
        }
        ...
        if ($post_active !== '') echo '<a class="option-tree-ui-button button" href="'.$post_active.'" target="_blank">' . esc_html__('Edit','uncode-core') . '</a>';
        else echo '<a class="option-tree-ui-button button hidden" href="" target="_blank">' . esc_html__('Edit','uncode-core') . '</a>';
    ...
    echo '<div class="format-setting type-link-color ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $ot_recognized_link_color_fields = apply_filters( 'ot_recognized_link_color_fields', array(
          'link'    => _x( 'Standard', 'color picker', 'uncode-core' ),
          'hover'   => _x( 'Hover', 'color picker', 'uncode-core' ),
          'active'  => _x( 'Active', 'color picker', 'uncode-core' ),
          'visited' => _x( 'Visited', 'color picker', 'uncode-core' ),
          'focus'   => _x( 'Focus', 'color picker', 'uncode-core' )
        ), $field_id );
  ...
  function ot_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
        ...
        echo '<p>' . esc_html__( 'No Pages Found', 'uncode-core' ) . '</p>';
      }
  ...
  function ot_type_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ($posts && $post_active !== '') echo '<a class="option-tree-ui-button button" href="'.$post_active.'" target="_blank">' . esc_html__('Edit','uncode-core') . '</a>';
        else echo '<a class="option-tree-ui-button button hidden" href="" target="_blank">' . esc_html__('Edit','uncode-core') . '</a>';
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'uncode-core' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
      ...
      $field_value = apply_filters( 'ot_type_social_links_defaults', array(
        array(
          'name'    => esc_html__( 'Facebook', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Twitter', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Google+', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'LinkedIn', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Pinterest', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Youtube', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Dribbble', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Github', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Forrst', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Digg', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Delicious', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Tumblr', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Skype', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'SoundCloud', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Vimeo', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Flickr', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'VK.com', 'uncode-core' ),
          'title'   => '',
          'href'    => ''
        )
      ), $field_id );
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'uncode-core' ) . '">' . esc_html__( 'Add New', 'uncode-core' ) . '</a>';

        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'uncode-core' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-spacing ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'top', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-up ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[top]" id="' . esc_attr( $field_id ) . '-top" value="' . $top . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'top', 'uncode-core' ) . '" /></div>';
        ...
        if ( in_array( 'right', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-right ot-option-group--icon"></span></span><input type="text" name="' . esc_attr( $field_name ) . '[right]" id="' . esc_attr( $field_id ) . '-right" value="' . $right . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'right', 'uncode-core' ) . '" /></div>';
        ...
        if ( in_array( 'bottom', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-down ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[bottom]" id="' . esc_attr( $field_id ) . '-bottom" value="' . $bottom . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'bottom', 'uncode-core' ) . '" /></div>';
        ...
        if ( in_array( 'left', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-left ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[left]" id="' . esc_attr( $field_id ) . '-left" value="' . $left . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'left', 'uncode-core' ) . '" /></div>';
    ...
    echo '<div class="format-setting type-tag-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<p>' . esc_html__( 'No Tags Found', 'uncode-core' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<option value="">' . esc_html__( 'No Tags Found', 'uncode-core' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<p>' . esc_html__( 'No Taxonomies Found', 'uncode-core' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<option value="">' . esc_html__( 'No Taxonomies Found', 'uncode-core' ) . '</option>';
        }
