...
function custom_theme_options()
{
	...
	$uncodeblocks = array(
		array(
			'value' => '','label' => esc_html__('Inherit', 'uncode-core')
		),
		array(
			'value' => 'none','label' => esc_html__('None', 'uncode-core')
		)
	);
	...
	if ($blocks_query->post_count === 0) {
		$uncodeblocks[] = array(
			'value' => '',
			'label' => esc_html__('No Content Blocks found', 'uncode-core')
		);
	}
	...
	$title_height = array(
		array(
			'value' => '',
			'label' => esc_html__('Default CSS', "uncode-core")
		),
	);
	...
	$header_type = array(
		...
		'desc' => esc_html__('Specify the Header type.', 'uncode-core'),
		'std' => 'none',
		'type' => 'select',
		'choices' => array(
			array(
	...
	$header_uncode_block = array(
		...
		'label' => esc_html__('Content Block', 'uncode-core') ,
		'desc' => esc_html__('Specify the Content Block.', 'uncode-core') ,
	...
	$enable_ajax_add_to_cart = array(
		...
		'desc' => esc_html__('Enable AJAX Add To Cart buttons on single product pages.', 'uncode-core') ,
		'std' => 'off',
		'type' => 'on-off',
		'section' => 'uncode_%section%_section',
		'condition' => '',
	...
	$body_uncode_block = array(
		...
		'label' => esc_html__('Content Block', 'uncode-core') ,
		'desc' => esc_html__('Define the Content Block to use. NB. Select "Inherit" to use the default template.', 'uncode-core') ,
		'type' => 'select',
		'choices' => $uncodeblocks,
		'section' => 'uncode_%section%_section',
	);
	...
	$body_uncode_block_before = array(
		...
		'desc' => esc_html__('Define the Content Block to use.', 'uncode-core') ,
		'type' => 'custom-post-type-select',
		'post_type' => 'uncodeblock',
		'section' => 'uncode_%section%_section',
	);
	...
	$body_layout_width = array(
		...
		'desc' => esc_html__('Specify the content width.', 'uncode-core'),
		'type' => 'select',
		'choices' => array(
			array(
				'value' => '',
	...
	$body_single_post_width = array(
		...
		'label' => esc_html__('Single post width', 'uncode-core') ,
		'desc' => esc_html__('Specify the Single Post width from 1 to 12.', 'uncode-core'),
		'type' => 'select',
		'std' => '4',
	...
	$body_single_text_lenght = array(
		...
		'label' => esc_html__('Single teaser text length', 'uncode-core') ,
		'desc' => esc_html__('Enter the number of words you want for the teaser. If nothing in entered the full content will be showed.', 'uncode-core') ,
		'type' => 'text',
		'section' => 'uncode_%section%_section',
		'condition' => '_uncode_%section%_content_block:is(),_uncode_%section%_content_block:is(none)',
		'operator' => 'or',
	...
	$footer_uncode_block = array(
		...
		'label' => esc_html__('Content Block', 'uncode-core') ,
		'desc' => esc_html__('Override the Content Block.', 'uncode-core') ,
		'type' => 'select',
		'choices' => $uncodeblocks,
		'section' => 'uncode_%section%_section',
	);
	...
	$custom_settings_section_three = array(
		...
		array(
			...
			'title' => '<i class="fa fa-map-o"></i> ' . esc_html__('Google Maps', 'uncode-core'),
			'group' => esc_html__('Utility', 'uncode-core')
		) ,
		array(
			'id' => 'uncode_redirect_section',
			'title' => '<i class="fa fa-reply2"></i> ' . esc_html__('Redirect', 'uncode-core'),
			'group' => esc_html__('Utility', 'uncode-core')
		) ,
		array(
	...
	$custom_settings_one = array(
		...
		array(
			...
			'desc' => esc_html__('Activate to show the WooCommerce icon in the Menu bar.', 'uncode-core') ,
			'std' => 'on',
			'type' => 'on-off',
			'section' => 'uncode_header_section',
		) ,
		array(
			...
			'label' => esc_html__('Cart Icon Menu bar', 'uncode-core') ,
		...
		array(
			...
			'label' => esc_html__('Cart Icon Menu bar device', 'uncode-core') ,
			'desc' => esc_html__('Show the WooCommerce cart icon in the Menu bar when layout is on mobile mode.', 'uncode-core') ,
			'std' => 'off',
			'type' => 'on-off',
			'section' => 'uncode_header_section',
			'condition' => '_uncode_woocommerce_cart:is(on)',
		...
		array(
			...
			'desc' => esc_html__('Insert additional text on top of the Menu (it works combined with the Secodnary Menu).','uncode-core') ,
			'type' => 'textarea',
			'section' => 'uncode_header_section',
	...
	$custom_settings_three = array(
		...
		array(
			...
			'label' => esc_html__('Custom fonts', 'uncode-core') ,
		...
		array(
			...
			'desc' => esc_html__('Specify the UI font family.', 'uncode-core') ,
			'std' => 'font-555555',
			'type' => 'select',
			'section' => 'uncode_customize_section',
			'operator' => 'or',
		...
		array(
			...
			'desc' => esc_html__('Specify the UI font weight.', 'uncode-core') ,
			'std' => '600',
			'type' => 'select',
			'section' => 'uncode_customize_section',
			'operator' => 'or',
		...
		array(
			...
			'label' => esc_html__('Input text underlined', 'uncode-core') ,
			'desc' => esc_html__('Activate to style all the input text with the underline.', 'uncode-core') ,
			'std' => 'off',
			'type' => 'on-off',
			'section' => 'uncode_customize_section',
		) ,
		...
		array(
			...
			'label' => '<i class="fa fa-download3"></i> ' . esc_html__('Buttons and Forms', 'uncode-core') ,
			'type' => 'textblock-titled',
			'class' => 'section-title',
			'section' => 'uncode_customize_section',
		) ,
		...
		array(
			...
			'label' => '<i class="fa fa-download3"></i> ' . esc_html__('Scroll & Parallax', 'uncode-core') ,
			'type' => 'textblock-titled',
			'class' => 'section-title',
	...
	if (class_exists('WooCommerce')) {
		...
		$custom_settings_three[] = array(
			...
			'label' => '<i class="fa fa-shopping-cart"></i> ' . esc_html__('WooCommerce', 'uncode-core') ,
			'type' => 'textblock-titled',
			'class' => 'section-title',
			'section' => 'uncode_extra_section',
		);
		...
		$custom_settings_three[] = array(
			...
			'label' => esc_html__('Enhance Add To Cart Button', 'uncode-core') ,
	...
	$custom_settings_four = array(
		array(
			...
			'label' => '<i class="fa fa-dashboard"></i> ' . esc_html__('Admin', 'uncode-core') ,
			'type' => 'textblock-titled',
			'class' => 'section-title',
			'section' => 'uncode_extra_section',
		) ,
	...
	$custom_settings_five = array(
		...
		array(
			...
			'label' => esc_html__('Content Block', 'uncode-core') ,
			'desc' => esc_html__('Specify the Content Block to use as a footer content.', 'uncode-core') ,
			'std' => '',
			'type' => 'custom-post-type-select',
			'section' => 'uncode_footer_section',
			'post_type' => 'uncodeblock',
		...
		array(
			...
			'label' => esc_html__('Scroll up button', 'uncode-core') ,
		...
		array(
			...
			'label' => esc_html__('Scroll up button mobile', 'uncode-core') ,
		...
		array(
			...
			'desc' => esc_html__('Define here all the Social Networks you will need.', 'uncode-core') ,
			'type' => 'list-item',
		...
		array(
			...
			'desc' => esc_html__('Activate to take advantage of the Adaptive Images system. Adaptive Images detects your visitor\'s screen size and automatically delivers device appropriate re-scaled images.', 'uncode-core') ,
			'std' => 'on',
			'type' => 'on-off',
		...
		array(
			'id' => '_uncode_redirect',
			'label' => esc_html__('Activate page redirect', 'uncode-core') ,
	...
	if (class_exists('WooCommerce'))
	{
		...
		$woocommerce_post = array(
			...
			str_replace('%section%', 'product', $enable_ajax_add_to_cart),
		...
		if ($layout == '_uncode_headers')
		{
			$array = array(
				...
				array(
					...
					'label' => esc_html__('Offcanvas', 'uncode-core') ,
