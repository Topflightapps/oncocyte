...
foreach ($uncode_post_types as $key => $value) {
	...
	$uncode_post_type_list = array(
		'type' => 'sorted_list',
		'heading' => ucfirst($value) . ' ' . esc_html__('element', 'uncode-core') ,
...
$uncode_post_list = array(
	'type' => 'sorted_list',
	'heading' => esc_html__('Posts', 'uncode-core') . ' ' . esc_html__('element', 'uncode-core') ,
...
$uncode_page_list = array(
	'type' => 'sorted_list',
	'heading' => esc_html__('Pages', 'uncode-core') . ' ' . esc_html__('element', 'uncode-core') ,
...
$uncode_product_list = array(
	'type' => 'sorted_list',
	'heading' => esc_html__('Products', 'uncode-core') . ' ' . esc_html__('element', 'uncode-core') ,
...
$uncode_index_params_first = array(
	...
	array(
		"type" => 'dropdown',
		"heading" => esc_html__("Module", 'uncode-core') ,
		"param_name" => "index_type",
		'admin_label' => true,
		"description" => esc_html__("Specify the layout mode: Isotope or Carousel.", 'uncode-core') ,
		"value" => array(
	...
	array(
		'type' => 'dropdown',
		'heading' => esc_html__('Layout modes', 'uncode-core') ,
		'param_name' => 'isotope_mode',
		"description" => wp_kses(__("Specify the Isotope layout mode. <a href='http://isotope.metafizzy.co/layout-modes.html' target='_blank'>Check this for reference</a>", 'uncode-core'), array( 'a' => array( 'href' => array( ),'target' => array( ) ) ) ) ,
		"value" => array(
	...
	array(
		'type' => 'loop',
		'heading' => esc_html__('Index content', 'uncode-core') ,
		'param_name' => 'loop',
		'admin_label' => true,
		'settings' => array(
			'size' => array(
	...
	array(
		"type" => 'checkbox',
		"heading" => esc_html__("Automatic query", 'uncode-core') ,
		"param_name" => "auto_query",
		"description" => esc_html__("Activate this to pull automatic query when used as Content Block for categories.", 'uncode-core') ,
		'group' => esc_html__('General', 'uncode-core') ,
		"value" => Array(
